      ...
      <div class="header-top">
        <div class="container">
          ...
          <div class="header-top__contacts">
            <a href="<?php echo get_template_directory_uri(); ?>/tel:+79219935550" class="header-phone">+7(921) 993-5550 </a>
            <a href="<?php echo get_template_directory_uri(); ?>/mailto:info@montessori-petersburg.com" class="header-email">info@montessori-petersburg.com</a>
          </div>
